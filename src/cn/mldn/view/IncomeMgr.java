...
public class IncomeMgr extends JInternalFrame {
	...
	private List<income> ali=new ArrayList<income>();
	/**
	...
	public IncomeMgr() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					List<income> ali1=new ArrayList<income>();
					System.out.println(textField.getText());
					if(textField.getText().equals(""))
						ali=new ServiceFactory().getIIncomeServiceInstance().findAll(new login().uname);
					else
						ali=new ServiceFactory().getIIncomeServiceInstance().FindIncome(new login().uname,
							textField.getText());
					//System.out.println(ali.get(0).getId()+ali.get(0).getItem());
					ali1=new IncomeT(1,ali).setCurentPageIndex();
					showTable(ali1);
				} catch (Exception e1) {
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ali=new ServiceFactory().getIIncomeServiceInstance().FindTime(new login().uname, Sdate, Edate);
					ali1=new IncomeT(1,ali).setCurentPageIndex();
					showTable(ali1);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					//ali=new ServiceFactory().getIIncomeServiceInstance().findAll(new login().uname);
					List<income> list=new IncomeT(1,ali).previousPage();
					showTable(list);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					//ali=new ServiceFactory().getIIncomeServiceInstance().findAll(new login().uname);
					List<income> list=new IncomeT(ali).previousPage();
					showTable(list);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					//ali=new ServiceFactory().getIIncomeServiceInstance().findAll(new login().uname);
					List<income> list=new IncomeT(ali).nextPage();
					showTable(list);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (JOptionPane.showConfirmDialog(button_4, "真的要删除吗？", "确认删除",
					...
					boolean flag=false;
					try {
						flag=new ServiceFactory().getIIncomeServiceInstance().
					...
					try {
						if(flag)
						{
							List<income>  ali1 = new ArrayList<income>();
							ali=new ServiceFactory().getIIncomeServiceInstance().findAll(new login().uname);
							ali1=new IncomeT(ali).setCurentPageIndex();
							showTable(ali1);
			...
			public void actionPerformed(ActionEvent e) {
				if (JOptionPane.showConfirmDialog(button_4, "真的要修改吗？", "确认修改",
					...
					else
					{
						...
						try {
							List <income> ali1=new ArrayList<income>();
							new ServiceFactory().getIIncomeServiceInstance().update(vo);
							ali=new ServiceFactory().getIIncomeServiceInstance().findAll(new login().uname);
							ali1=new IncomeT(ali).setCurentPageIndex();
							showTable(ali1);
	...
	public void showTable(List<income> ali)
	{
